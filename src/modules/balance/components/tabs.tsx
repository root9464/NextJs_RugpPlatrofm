...
import { Jetton, useUserBalance } from '../hooks/useUserBalance';
import { NftItemsType, useUserNft } from '../hooks/useUserNft';
...
type BalanceTabsProps = {
  address: string;
  TokenTable: ({ tokens }: { tokens: Jetton[] }) => JSX.Element;
  NftsGrid: ({ nfts }: { nfts: NftItemsType[] }) => JSX.Element;
};
