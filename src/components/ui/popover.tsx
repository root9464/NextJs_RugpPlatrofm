...
import type { DialogTriggerProps, ModalOverlayProps, PopoverProps as PopoverPrimitiveProps } from 'react-aria-components';
import {
  type DialogProps,
  DialogTrigger,
  Modal,
...
const PopoverHeader = ({ className, ...props }: DialogHeaderProps) => <Dialog.Header className={twMerge('sm:p-4', className)} {...props} />;
...
const PopoverContent = ({ respectScreen = true, children, showArrow = true, className, ...props }: PopoverContentProps) => {
